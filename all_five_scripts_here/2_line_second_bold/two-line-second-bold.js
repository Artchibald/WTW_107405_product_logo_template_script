...
*********************************/
    ...
    for (var i_9 = 0; i_9 < textGroup.pathItems.length; i_9++) {
        textGroup.pathItems[i_9].fillColor = rgbBlack;
    }
    for (var i_10 = 0; i_10 < textGroup2.pathItems.length; i_10++) {
        textGroup2.pathItems[i_10].fillColor = rgbBlack;
    }
    //#endregion
    ...
    ********************/
    ...
    for (var i_25 = 0; i_25 < doc.pathItems.length; i_25++) {
        var path = doc.pathItems[i_25];
