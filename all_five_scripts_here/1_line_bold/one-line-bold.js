...
**********************************************************************/
    ...
    ********************/
    ...
    for (var i_24 = 0; i_24 < doc.pathItems.length; i_24++) {
        var path = doc.pathItems[i_24];
...
*********************************/
    ...
    rgbBlack.blue = 0;
    // Loop through each path item in the text group
    for (var i_32 = 0; i_32 < textGroup.pathItems.length; i_32++) {
        textGroup.pathItems[i_32].fillColor = rgbBlack;
    }
    //#endregion
}
