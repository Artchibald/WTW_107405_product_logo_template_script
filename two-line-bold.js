...
var appNameCore = prompt("What name do you want to put in the first line Core lockup?");
// request a second line of text
var appNameCore2 = prompt("What name do you want to put in the second line Core lockup?");
//request a name for the icon, and place that as text on the lockup artboard
...
*********************************/
    ...
    ********************/
    ...
    var mastTextOffset2 = CSTasks.getOffset(textGroup2.position, CSTasks.getArtboardCorner(sourceDoc.artboards[0]));
    // duplicate text
    var mastText2 = textGroup.duplicate(mastDoc.layers[0], 
    /*@ts-ignore*/
    ElementPlacement.PLACEATEND);
    // text position
    var mastTextLoc2 = [
        mastDoc.artboards[0].artboardRect[0] + mastTextOffset2[0],
        mastDoc.artboards[0].artboardRect[1] + mastTextOffset2[1],
    ];
    // paste text
...
function createAndExportArtboard3() {
    ...
    *********************************/
    ...
    var setMainVioletBgColorMastDocCMYK = new RGBColor();
    ...
    var setClipBgColorMastDocCMYK = new RGBColor();
